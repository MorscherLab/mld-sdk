...
<template>
  ...
  <DemoSection title="On Different Elements">
    <div class="flex gap-4 items-center">
      <Tooltip text="This is a helpful hint">
        <span class="text-sm text-text-secondary underline decoration-dashed cursor-help">
  ...
  <!-- Custom Delay -->
  <DemoSection title="Custom Delay">
    <div class="flex gap-4 items-center">
      <Tooltip text="Instant tooltip (0ms delay)" :delay="0">
        <BaseButton variant="secondary">No Delay</BaseButton>
      </Tooltip>

      <Tooltip text="Slow tooltip (500ms delay)" :delay="500">
        <BaseButton variant="secondary">500ms Delay</BaseButton>
      </Tooltip>
    </div>
  </DemoSection>
</template>
